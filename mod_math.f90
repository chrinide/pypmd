...
contains 
  ...
  SUBROUTINE DGECO(A,LDA,N,IPVT,RCOND,Z)
      ...
      real(kind=rp) A(LDA,1),Z(1)
      real(kind=rp) RCOND
!
!     DGECO FACTORS A real(kind=rp) MATRIX BY GAUSSIAN ELIMINATION
...
!     INTERNAL VARIABLES
!
      real(kind=rp) EK,T,WK,WKM
      real(kind=rp) ANORM,S,SM,YNORM
...
!
  ...
  SUBROUTINE DGEFA(A,LDA,N,IPVT,INFO)
      ...
      real(kind=rp) A(LDA,1)
!
!     DGEFA FACTORS A real(kind=rp) MATRIX BY GAUSSIAN ELIMINATION.
!
...
!
  ...
  SUBROUTINE DGESL(A,LDA,N,IPVT,B,JOB)
      ...
      real(kind=rp) A(LDA,1),B(1)
!
!     DGESL SOLVES THE real(kind=rp) SYSTEM
...
!
  ...
  SUBROUTINE DGEDI(A,LDA,N,IPVT,DET,WORK,JOB)
      INTEGER LDA,N,IPVT(1),JOB
      real(kind=rp) A(LDA,1),DET(2),WORK(1)
!
...
!
  ...
  SUBROUTINE DGBCO(ABD,LDA,N,ML,MU,IPVT,RCOND,Z)
      ...
      real(kind=rp) ABD(LDA,1),Z(1)
      real(kind=rp) RCOND
!
!     DGBCO FACTORS A real(kind=rp) BAND MATRIX BY GAUSSIAN
...
!
  ...
  SUBROUTINE DGBFA(ABD,LDA,N,ML,MU,IPVT,INFO)
      ...
      real(kind=rp) ABD(LDA,1)
!
!     DGBFA FACTORS A real(kind=rp) BAND MATRIX BY ELIMINATION.
!
...
!
  ...
  SUBROUTINE DGBSL(ABD,LDA,N,ML,MU,IPVT,B,JOB)
      ...
      real(kind=rp) ABD(LDA,1),B(1)
!
!     DGBSL SOLVES THE real(kind=rp) BAND SYSTEM
!     A * X = B  OR  TRANS(A) * X = B
...
!     ...EXIT
  ...
  SUBROUTINE DPOCO(A,LDA,N,RCOND,Z,INFO)
      ...
      real(kind=rp) RCOND
!
!     DPOCO FACTORS A real(kind=rp) SYMMETRIC POSITIVE DEFINITE
...
!
  ...
  SUBROUTINE DPOFA(A,LDA,N,INFO)
      ...
      real(kind=rp) A(LDA,1)
!
!     DPOFA FACTORS A real(kind=rp) SYMMETRIC POSITIVE DEFINITE
!     MATRIX.
!
...
!     ......EXIT
  ...
  SUBROUTINE DPOSL(A,LDA,N,B)
      ...
      real(kind=rp) A(LDA,1),B(1)
!
!     DPOSL SOLVES THE real(kind=rp) SYMMETRIC POSITIVE DEFINITE
!     SYSTEM A * X = B
...
!     real(kind=rp) SYMMETRIC POSITIVE DEFINITE MATRIX (SEE BELOW)
...
!
  ...
  SUBROUTINE DPPCO(AP,N,RCOND,Z,INFO)
      INTEGER N,INFO
      real(kind=rp) AP(1),Z(1)
      real(kind=rp) RCOND
!
!     DPPCO FACTORS A real(kind=rp) SYMMETRIC POSITIVE DEFINITE
...
!
  ...
  SUBROUTINE DPPFA(AP,N,INFO)
      ...
      real(kind=rp) AP(1)
!
!     DPPFA FACTORS A real(kind=rp) SYMMETRIC POSITIVE DEFINITE
!     MATRIX STORED IN PACKED FORM.
!
...
!     ......EXIT
  ...
  SUBROUTINE DPPSL(AP,N,B)
      INTEGER N
      real(kind=rp) AP(1),B(1)
!
!     DPPSL SOLVES THE real(kind=rp) SYMMETRIC POSITIVE DEFINITE
!     SYSTEM A * X = B
...
!     OF A real(kind=rp) SYMMETRIC POSITIVE DEFINITE MATRIX
!     USING THE FACTORS COMPUTED BY DPPCO OR DPPFA .
!
!     ON ENTRY
!
...
!
  ...
  SUBROUTINE DPBCO(ABD,LDA,N,M,RCOND,Z,INFO)
      ...
      real(kind=rp) RCOND
!
!     DPBCO FACTORS A real(kind=rp) SYMMETRIC POSITIVE DEFINITE
...
!
  ...
  SUBROUTINE DPBFA(ABD,LDA,N,M,INFO)
      ...
      real(kind=rp) ABD(LDA,1)
!
!     DPBFA FACTORS A real(kind=rp) SYMMETRIC POSITIVE DEFINITE
...
!     ......EXIT
  ...
  SUBROUTINE DPBSL(ABD,LDA,N,M,B)
      ...
      real(kind=rp) ABD(LDA,1),B(1)
!
!     DPBSL SOLVES THE real(kind=rp) SYMMETRIC POSITIVE DEFINITE
!     BAND SYSTEM  A*X = B
...
!     OF A real(kind=rp) SYMMETRIC POSITIVE DEFINITE BAND MATRIX
!     USING THE FACTORS COMPUTED BY DPBCO OR DPBFA.
...
!     ...EXIT
  ...
  SUBROUTINE DSICO(A,LDA,N,KPVT,RCOND,Z)
      ...
      real(kind=rp) RCOND
!
!     DSICO FACTORS A real(kind=rp) SYMMETRIC MATRIX BY ELIMINATION
...
!     INTERNAL VARIABLES
!
      real(kind=rp) AK,AKM1,BK,BKM1,DENOM,EK,T
      real(kind=rp) ANORM,S,YNORM
...
!
  ...
  SUBROUTINE DSIFA(A,LDA,N,KPVT,INFO)
      ...
      real(kind=rp) A(LDA,1)
!
!     DSIFA FACTORS A real(kind=rp) SYMMETRIC MATRIX BY ELIMINATION
...
!     INTERNAL VARIABLES
!
      real(kind=rp) AK,AKM1,BK,BKM1,DENOM,MULK,MULKM1,T
      real(kind=rp) ABSAKK,ALPHA,COLMAX,ROWMAX
...
!
  ...
  SUBROUTINE DSISL(A,LDA,N,KPVT,B)
      ...
      real(kind=rp) A(LDA,1),B(1)
!
!     DSISL SOLVES THE real(kind=rp) SYMMETRIC SYSTEM
!     A * X = B
...
!     INTERNAL VARIABLES.
!
      real(kind=rp) AK,AKM1,BK,BKM1,DENOM,TEMP
      INTEGER K,KP
!
...
!
  ...
  SUBROUTINE DSIDI(A,LDA,N,KPVT,DET,INERT,WORK,JOB)
      INTEGER LDA,N,JOB
      real(kind=rp) A(LDA,1),WORK(1)
      real(kind=rp) DET(2)
      INTEGER KPVT(1),INERT(3)
!
!     DSIDI COMPUTES THE DETERMINANT, INERTIA AND INVERSE
!     OF A real(kind=rp) SYMMETRIC MATRIX USING THE FACTORS FROM
!     DSIFA.
!
!     ON ENTRY
!
...
!     INTERNAL VARIABLES.
!
      real(kind=rp) AKKP1,TEMP
      real(kind=rp) TEN,D,T,AK,AKP1
...
!
  ...
  SUBROUTINE DSPCO(AP,N,KPVT,RCOND,Z)
      ...
      real(kind=rp) RCOND
!
!     DSPCO FACTORS A real(kind=rp) SYMMETRIC MATRIX STORED IN
...
!
  ...
  SUBROUTINE DSPFA(AP,N,KPVT,INFO)
      ...
      real(kind=rp) AP(1)
!
!     DSPFA FACTORS A real(kind=rp) SYMMETRIC MATRIX STORED IN
...
!
  ...
  SUBROUTINE DTRCO(T,LDT,N,RCOND,Z,JOB)
      INTEGER LDT,N,JOB
      real(kind=rp) T(LDT,1),Z(1)
      real(kind=rp) RCOND
!
!     DTRCO ESTIMATES THE CONDITION OF A real(kind=rp) TRIANGULAR
!     MATRIX.
!
!     ON ENTRY
!
!        T       real(kind=rp)(LDT,N)
...
!     INTERNAL VARIABLES
!
      real(kind=rp) W,WK,WKM,EK
      real(kind=rp) TNORM,YNORM,S,SM
...
!
  ...
  SUBROUTINE DTRDI(T,LDT,N,DET,JOB,INFO)
      INTEGER LDT,N,JOB,INFO
      real(kind=rp) T(LDT,1),DET(2)
!
!     DTRDI COMPUTES THE DETERMINANT AND INVERSE OF A real(kind=rp)
!     TRIANGULAR MATRIX.
!
!     ON ENTRY
!
...
!
  ...
  SUBROUTINE DPTSL(N,D,E,B)
      INTEGER N
      real(kind=rp) D(1400),E(1400),B(1400)
!
...
!
  ...
  SUBROUTINE DCHUD(R,LDR,P,X,Z,LDZ,NZ,Y,RHO,C,S)
      ...
      real(kind=rp) RHO(1),C(1)
      real(kind=rp) R(LDR,1),X(1),Z(LDZ,1),Y(1),S(1)
!
...
!                       (    -S(I)      C(I) )
!
!     THE ROTATIONS ARE CHOSEN SO THAT C(I) IS real(kind=rp).
!
!     ON ENTRY
!
!         R      real(kind=rp)(LDR,P), WHERE LDR .GE. P.
...
!
!         Z      real(kind=rp)(LDZ,NZ), WHERE LDZ .GE. P.
...
!
      INTEGER I,J,JM1
      real(kind=rp) AZETA,SCALE
      real(kind=rp) T,XJ,ZETA
!
!     UPDATE R.
!
      DO 30 J = 1, P
...
!
      INTEGER I,II,J
      real(kind=rp) A,ALPHA,AZETA,NORM
      real(kind=rp) T,ZETA,B,XX
!
...
!
  ...
  SUBROUTINE DCHEX(R,LDR,P,K,L,Z,LDZ,NZ,C,S,JOB)
      ...
      real(kind=rp) R(LDR,1),Z(LDZ,1),S(1)
      real(kind=rp) C(1)
!
...
!                           (    -S(I)      C(I) )
!
!     WHERE C(I) IS real(kind=rp), THE ROWS THESE ROTATIONS OPERATE
...
!
  ...
  SUBROUTINE DQRDC(X,LDX,N,P,QRAUX,JPVT,WORK,JOB)
      INTEGER LDX,N,P,JOB
      INTEGER JPVT(1)
      real(kind=rp) X(LDX,1),QRAUX(1),WORK(1)
!
...
!     ON ENTRY
!
!        X       real(kind=rp)(LDX,P), WHERE LDX .GE. N.
...
!
      ...
      real(kind=rp) MAXNRM,TT
      real(kind=rp) NRMXL,T
      LOGICAL NEGJ,SWAPJ
!
!
      PL = 1
...
!
  ...
  SUBROUTINE DQRSL(X,LDX,N,K,QRAUX,Y,QY,QTY,B,RSD,XB,JOB,INFO)
      ...
      real(kind=rp) X(LDX,1),QRAUX(1),Y(1),QY(1),QTY(1),B(1),RSD(1),XB(1)
!
...
!
  ...
  SUBROUTINE DSVDC(X,LDX,N,P,S,E,U,LDU,V,LDV,WORK,JOB,INFO)
      ...
      real(kind=rp) X(LDX,1),S(1),E(1),U(LDU,1),V(LDV,1),WORK(1)
!
!
!     DSVDC IS A SUBROUTINE TO REDUCE A real(kind=rp) NXP MATRIX X
...
!     ON RETURN
!
!         S         real(kind=rp)(MM), WHERE MM=MIN(N+1,P).
...
!
!         U         real(kind=rp)(LDU,K), WHERE LDU.GE.N.  IF
...
!
!         V         real(kind=rp)(LDV,P), WHERE LDV.GE.P.
...
!
      ...
      real(kind=rp) T,R
      real(kind=rp) B,C,CS,EL,EMM1,F,G,SCALE,SHIFT,SL,SM,SN,&
         SMM1,T1,TEST,ZTEST
      LOGICAL WANTU,WANTV
!
!
...
!           ...EXIT
  ...
  real(kind=rp) FUNCTION DASUM(N,DX,INCX)
!
!     TAKES THE SUM OF THE ABSOLUTE VALUES.
!     JACK DONGARRA, LINPACK, 3/11/78.
!
      real(kind=rp) DX(1),DTEMP
...
!
  ...
  real(kind=rp) FUNCTION DDOT(N,DX,INCX,DY,INCY)
!
!     FORMS THE DOT PRODUCT OF TWO VECTORS.
!     USES UNROLLED LOOPS FOR INCREMENTS EQUAL TO ONE.
!     JACK DONGARRA, LINPACK, 3/11/78.
!
      real(kind=rp) DX(1),DY(1),DTEMP
      INTEGER I,INCX,INCY,IX,IY,M,MP1,N
!
      DDOT = 0.0D0
      DTEMP = 0.0D0
...
!
  ...
  real(kind=rp) FUNCTION DMACH(JOB)
      INTEGER JOB
!
...
!
  ...
  real(kind=rp) FUNCTION DNRM2 ( N, DX, INCX)
      INTEGER          NEXT
      real(kind=rp)   DX(1), CUTLO, CUTHI, HITEST, SUM, XMAX,ZERO,ONE
...
!     JACK DONGARRA, LINPACK, 3/11/78.
!
      real(kind=rp) DX(1),DY(1),DTEMP,C,S
...
!     JACK DONGARRA, LINPACK, 3/11/78.
!
      real(kind=rp) DA,DB,C,S,ROE,SCALE,R,Z
!
      ROE = DB
